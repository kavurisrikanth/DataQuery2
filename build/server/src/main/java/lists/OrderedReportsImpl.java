  ...
  public List<NativeObj> getNativeResult() {
    Query query =
        em.createNativeQuery(
            "select b._name a0, a._student_id a1, a._id a2 from _report a left join _student b on b._id = a._student_id order by b._name");
